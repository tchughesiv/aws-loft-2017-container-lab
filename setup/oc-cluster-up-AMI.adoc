...
* Install a couple of packages: "sudo yum -y install ansible python2-docker python-devel git wget firewalld docker bash-completion"
* Install the development tools: "sudo yum groupinstall -y "Development Tools"
